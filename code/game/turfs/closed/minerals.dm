...
/turf/closed/mineral/ice
	name = "icy wall"
	desc = "Frozen water forms wavy patterns, not unlike a rock face. Looking through, the world beyond is tinted hues of blue."
...
/turf/closed/mineral/random/asteroid/wasteplanet
	name = "polluted stone"
	desc = "Whatever numen once held sway, the poison is all that remains."
