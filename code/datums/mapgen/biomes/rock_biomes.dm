/datum/biome/rock
	open_turf_types = list(/turf/open/floor/plating/asteroid/rockplanet/lit = 2, /turf/open/floor/plating/asteroid/rockplanet/cracked/lit = 1)
	...
	flora_spawn_list = list(
		...
		/obj/structure/flora/grass/rockplanet/dead = 4,
	)
...
/datum/biome/rock/icecap
	open_turf_types = list(/turf/open/floor/plating/asteroid/rockplanet/cracked/lit = 1, /turf/open/floor/plating/asteroid/snow/lit/rockplanet = 5)
	flora_spawn_chance = 2
	mob_spawn_chance = 2
	flora_spawn_list = list(
		/obj/structure/flora/rock/rockplanet = 2,
		/obj/structure/flora/grass/rockplanet = 6,
	)
...
//		/mob/living/simple_animal/hostile/ooze/grapes/asteroid = 20,
		...
		/mob/living/simple_animal/hostile/asteroid/whitesands/survivor/random = 20,
	)
